...
diccEstudiantes["Julian Orrego"] = 4.8
diccEstudiantes["Fernanda Salazar"] = 3.9
diccEstudiantes["Pedro Paco"] = 2.5
print("la nueva lista de estudiantes es: " , diccEstudiantes)
